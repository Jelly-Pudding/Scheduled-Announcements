...
**ScheduledAnnouncements** is a Minecraft Paper 1.21.8 plugin that allows server administrators to schedule automated announcements using cron expressions.
